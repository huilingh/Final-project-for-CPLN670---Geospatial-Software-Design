"""
THIS SCRIPT WILL:
A.  EXTRACT VALUES FROM RASTER (THE INDICATOR AND DECISION FACTORS OF ESI) AND SPATIAL JOIN THE VALUES TO EACH FISHNET GRID CELL
B.  RUN GWR ON EACH GRID CELL AND RECLASSIFY THE PREDICTED VALUES (PREDICTED ALOS TOPOGRAPHIC DIVERSITY) INTO FOUR EQUAL INTERVALS
...
6   In the next dialog box, specify the following inputs (using dropdown menus wherever possible)
    before pressing OK or Finish.
        ...
        predictor raster5   Raster Layer        Input
